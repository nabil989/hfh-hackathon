...
function Center() {
    const resetEarth=() => {
        document.getElementById("earth").style.transform = "scale(0.75)";
    }
    const click = () =>{
  ...
  return (
    <div className='w-1/3 h-screen text-center text-white flex flex-col items-center'>
        <div className='p-6 mb-20 text-4xl font-bold font'>
            April 2022
        </div>
        <div className='transition-all duration-75 scale-75' id="earth" onClick={click}>
